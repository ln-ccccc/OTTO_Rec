...
**算法逻辑**:
- Click-Click 矩阵 :
  - 含义 : “看了 Item A 的人，紧接着也看了 Item B”。
  - 作用 : 捕捉用户的 浏览兴趣漂移 （比如在比价、看同类竞品）。
- Cart-Order 矩阵 :
  - 含义 : “把 Item A 加购物车的人，最终买了 Item B”。
  - 作用 : 捕捉 强转化关联 （比如 A 是 B 的配件，或者 A 是 B 的前置需求）。
- Buy-Buy 矩阵 :
  - 含义 : “买了 Item A 的人，同时也买了 Item B”。
  - 作用 : 捕捉 搭配购买 （比如买了手机，又买了耳机）。
